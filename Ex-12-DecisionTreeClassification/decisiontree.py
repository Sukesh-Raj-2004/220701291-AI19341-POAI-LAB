...
and Test set from sklearn.model_selection import
train_test_split
...
on the Training set from sklearn.tree import
...
j) plt.title('Decision Tree Classification
(Training set)') plt.xlabel('Age')
